...
class SwitchFloatingActionButton : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_switch_floating_action_button)

        metros = findViewById(R.id.editMetros5)
        //opciones = findViewById(R.id.radiogroup)
        pies = findViewById(R.id.swPie)
        pulgadas = findViewById(R.id.swPulgada)
        yardas = findViewById(R.id.swYarda)
        resultado = findViewById(R.id.txtResultado5)
